...
{
	::CreateWindow("button", "one", WS_CHILD | WS_VISIBLE, 200, 200, 100, 50, hw, ::HMENU(id_button1), 0, 0);
	::CreateWindow("button", "two", WS_CHILD | WS_VISIBLE, 350, 200, 100, 50, hw, ::HMENU(id_button2), 0, 0);
